...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 116.0, 314.0, 32.0, 22.0 ],
					"text" : "print"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 107.5, 246.0, 49.0, 22.0 ],
					"text" : "params"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "The idea here is to unobtrusively mute the current voice when another poly~ voice corresponding to the the same piano starts playing. For instance, if this is piano 1 voice 1, we will mute it when piano 1 voice 3 is called by the controller. This helps reduce CPU usage which would spike if all voices are allowed to resonate al niente."
				}
...
, 			{
				"box" : 				{
					...
					"text" : "if ($i1 == #1) && ($i3 - $i2 == 2 || $i3 - $i2 == -1) then bang"
				}
...
,
									"fileref" : 									{
										...
										"filepos" : -1,
										"snapshotfileid" : "1323dbce660abce4a35384f9104d4ae9"
									}
